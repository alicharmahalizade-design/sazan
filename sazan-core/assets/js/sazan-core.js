( function( $ ) {
	...
	function initSticky( $h ) {
		...
		var stuck = false, info = null, triggerY = 0;
		...
		function unstick() {
			...
			el.classList.remove( 'sz-fixed', 'sz-shrunk', 'sz-hidden' );
			[ 'position', 'left', 'right', 'top', 'margin', 'zIndex', 'backgroundColor', 'backgroundImage', 'backdropFilter', 'webkitBackdropFilter' ].forEach( function ( p ) { el.style[ p ] = ''; } );

...
class SPP_Settings {
	...
	public static function fields() {
		return (array) apply_filters( 'spp_global_fields', array(
			...
			'g_enroll' => array(
				'type'  => 'group',
				'label' => 'ثبت‌نام کارت‌به‌کارت (مشترک بین همه‌ی دوره‌ها)',
			),
			'enroll_card_number' => array(
				'type'    => 'text',
				'label'   => 'شماره کارت',
				'default' => '',
				'hint'    => 'شماره ۱۶ رقمی کارت که در پاپ‌آپ ثبت‌نام به کاربر نمایش داده می‌شود. برای یک دوره‌ی خاص می‌توانی در متاباکس همان محصول شماره‌ی دیگری بگذاری.',
			),
			'enroll_iban' => array(
				'type'    => 'text',
				'label'   => 'شماره شبا',
			...
			'enroll_note' => array(
				'type'    => 'textarea',
				'label'   => 'توضیح پاپ‌آپ ثبت‌نام',
				'default' => 'مبلغ دوره را به شماره کارت زیر واریز کنید، سپس تصویر رسید واریزی و مشخصات خود را در همین فرم ثبت کنید. پس از بررسی رسید، ثبت‌نام شما نهایی می‌شود و با شما تماس می‌گیریم.',
			),
			'enroll_success' => array(
				'type'    => 'textarea',
				'label'   => 'پیام پس از ثبت درخواست',
				'default' => 'ثبت‌نام شما ثبت شد. رسید واریزی بررسی می‌شود و به‌زودی با شما تماس می‌گیریم.',
			),
			'enroll_admin_email' => array(
				'type'  => 'text',
				'label' => 'ایمیل دریافت اعلان ثبت‌نام',
				'hint'  => 'اگر خالی بماند، اعلان به ایمیل مدیر سایت فرستاده می‌شود. برای چند گیرنده، ایمیل‌ها را با ویرگول جدا کنید.',
			),

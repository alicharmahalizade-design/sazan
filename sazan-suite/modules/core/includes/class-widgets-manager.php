...
final class Widgets_Manager {
	...
	private $widgets = array(
		...
		'hero-cats/class-sazan-hero-cats.php' => '\Sazan\Widgets\Hero_Cats',
		...
		'product-slider/class-sazan-product-slider.php' => '\Sazan\Widgets\Product_Slider',
		'assessment/class-sazan-assessment-landing.php' => '\Sazan\Widgets\Assessment_Landing',
	);
	...
	public function register_widgets( $widgets_manager ) {
		...
		$single_blog = SAZAN_CORE_PATH . 'widgets/single-blog/class-sazan-single-blog-widgets.php';
		if ( file_exists( $single_blog ) ) {
			require_once $single_blog;
			if ( function_exists( '\\Sazan\\Widgets\\Single_Blog\\widget_classes' ) ) {
				foreach ( \Sazan\Widgets\Single_Blog\widget_classes() as $class ) {
					if ( class_exists( $class ) ) {
						$widgets_manager->register( new $class() );
					}
				}

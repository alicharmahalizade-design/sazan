...
final class Core {
	...
	private function includes() {
		...
		require_once SAZAN_CORE_PATH . 'includes/class-single-blog-meta.php';
		require_once SAZAN_CORE_PATH . 'includes/class-single-blog.php';
		require_once SAZAN_CORE_PATH . 'includes/class-single-blog-seo.php';
		require_once SAZAN_CORE_PATH . 'includes/class-assessment-landing.php';
	...
	private function hooks() {
		...
		Single_Blog_Meta::instance();
		Single_Blog::instance();
		Single_Blog_SEO::instance();
		Assessment_Landing_Page::instance();
		Assets::instance();
	...
	public function register_category( $elements_manager ) {
		...
		$elements_manager->add_category(
			'sazan-single-blog',
			array(
				'title' => esc_html__( 'تک بلاگ سازان', 'sazan-core' ),

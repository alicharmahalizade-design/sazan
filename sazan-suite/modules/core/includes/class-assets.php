...
final class Assets {
	...
	public function frontend_assets() {
		wp_register_style(
			'sazan-single-blog',
			SAZAN_CORE_URL . 'assets/css/sazan-single-blog.css',
			array(),
			$this->ver( 'assets/css/sazan-single-blog.css' )
		);

		wp_register_style(
			'sazan-assessment-landing',
			SAZAN_CORE_URL . 'assets/css/sazan-assessment-landing.css',
			array(),
			$this->ver( 'assets/css/sazan-assessment-landing.css' )
		);
		wp_register_script(
			'sazan-assessment-landing',
			SAZAN_CORE_URL . 'assets/js/sazan-assessment-landing.js',
			array(),
			$this->ver( 'assets/js/sazan-assessment-landing.js' ),
			true
		);

		wp_register_script(
			'sazan-single-blog',
			SAZAN_CORE_URL . 'assets/js/sazan-single-blog.js',
			array(),
			$this->ver( 'assets/js/sazan-single-blog.js' ),
			true
		);
		...
		if ( class_exists( __NAMESPACE__ . '\\Single_Blog' ) && Single_Blog::is_active_request() ) {
			wp_enqueue_style( 'sazan-single-blog' );
			wp_enqueue_script( 'sazan-single-blog' );
		}
	}
	...
	public function editor_assets() {
		...
		wp_enqueue_style(
			'sazan-single-blog-editor',
			SAZAN_CORE_URL . 'assets/css/sazan-single-blog.css',
			array(),
			$this->ver( 'assets/css/sazan-single-blog.css' )
		);
		wp_enqueue_style(
			'sazan-assessment-landing-editor',
			SAZAN_CORE_URL . 'assets/css/sazan-assessment-landing.css',
			array(),
			$this->ver( 'assets/css/sazan-assessment-landing.css' )
		);

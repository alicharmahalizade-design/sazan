<?php
/**
 * ماژول «هسته و ویجت‌ها» از سوئیت سازان.
 *
 * این فایل قبلاً فایل اصلی افزونه‌ی مستقل «Sazan Core» بود و اکنون به‌عنوان یک
 * ماژول از داخل sazan-suite.php بارگذاری می‌شود.
 *
 * @package Sazan\Suite\Modules\Core
 */
...
/* ثابت‌های افزونه ------------------------------------------------------- */
define( 'SAZAN_CORE_VERSION', '3.42.0' );
...
// فعال‌سازی از طریق Sazan_Suite_Modules مدیریت می‌شود.

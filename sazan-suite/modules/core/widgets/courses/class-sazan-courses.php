...
class Courses extends Widget_Base {
	...
	protected function render() {
		...
		/* طرح‌های پوستری (حرفه‌ای/لاکچری) روی «استیجِ» شیشه‌ایِ تیره می‌نشینند
		   تا با ویجت‌های «خدمات ما» و «اسلایدر دوره» هم‌سبک شوند. */
		$stage = in_array( $skin, array( 'pro', 'lux' ), true ) ? ' has-stage' : '';
		echo '<div class="sazan-sec sazan-courses skin-' . esc_attr( $skin ) . esc_attr( $stage ) . '">';

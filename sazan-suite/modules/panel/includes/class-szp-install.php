...
class SZP_Install {
	...
	public static function create_tables() {
		...
		$er = $wpdb->prefix . 'szp_eval_revisions';
		...
		CREATE TABLE $ev (
			...
			note longtext NULL,
			target_success longtext NULL,
			target_customers int(11) unsigned NOT NULL DEFAULT 0,
			target_actions longtext NULL,
			target_obstacle longtext NULL,
			target_obstacle_plan longtext NULL,
			motivation tinyint(3) unsigned NOT NULL DEFAULT 0,
			commitment tinyint(3) unsigned NOT NULL DEFAULT 0,
			target_complete tinyint(1) NOT NULL DEFAULT 0,
			result_percent double NOT NULL DEFAULT 0,
			result_customers int(11) unsigned NOT NULL DEFAULT 0,
			result_success longtext NULL,
			result_weakness longtext NULL,
			result_learning longtext NULL,
			result_complete tinyint(1) NOT NULL DEFAULT 0,

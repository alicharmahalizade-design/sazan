...
class SZP_W_Coaching extends SZP_Widget_Base {
	...
	public function get_title() { return 'سازان: کوچینگ قدیمی (غیرفعال)'; }
	...
	public function render() {
		// Kept only so existing Elementor pages do not break; legacy output is disabled.
		return;
	}
...
class SZP_W_My_Eval extends SZP_Widget_Base {
	...
	public function get_title() { return 'سازان: رشد و کوچینگ'; }
	public function get_icon() { return 'eicon-number-field'; }
	public function get_keywords() { return array( 'sazan', 'growth', 'coach', 'eval', 'target', 'رشد', 'کوچینگ', 'ارزیابی', 'تارگت', 'سازان' ); }

...
/** متن قابل‌ویرایش رابط؛ با fallback برای سازگاری نسخه‌های قدیمی. */
function szp_ui_text( $key, $fallback = '' ) {
	return class_exists( 'SZP_Settings' ) ? SZP_Settings::text( $key, $fallback ) : $fallback;
}

...
<div class="szp szp-skin-neon">
	...
	<h2 class="szp-h"><?php echo esc_html( szp_ui_text( 'courses_title', 'دوره‌های من' ) ); ?></h2>

	<?php if ( ! $ids ) : ?>
		<div class="szp-empty"><?php echo esc_html( szp_ui_text( 'courses_empty', 'هنوز دوره‌ای برای شما ثبت نشده است.' ) ); ?></div>
	<?php else : ?>
		<div class="szp-grid">

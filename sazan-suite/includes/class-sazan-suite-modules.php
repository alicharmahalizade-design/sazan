...
class Sazan_Suite_Modules {
	...
	public static function all() {
		return array(
			...
			'homepage-premium' => array(
				'label'       => 'صفحه اصلی پریمیوم Elementor',
				'description' => '۹ ویجت مستقل Elementor برای هدر، هیرو، خدمات، دوره‌های دستی، مشاوره، درباره، تقویم، آخرین مقالات داینامیک و فوتر؛ همراه با ساخت فوری و پیش‌نمایش.',
				'icon'        => 'dashicons-admin-home',
				'sentinel'    => 'SAZAN_HOMEPAGE_PREMIUM_VERSION',
				'legacy'      => '',
				'legacy_name' => 'Sazan Premium Homepage',
				'activate'    => '',
				'deactivate'  => '',
				'requires'    => array( 'elementor' ),
			),

...
class HKL_Widget_Final_Cta extends HKL_Widget_Base {
	...
	protected function render_html( array $s ) {
		...
		?>
<section<?php echo self::id_attr( self::v( $s, 'section_id' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="final-cta"><div class="container"><p><?php echo self::t( self::v( $s, 'kicker' ) ); ?></p><h2><?php echo $title; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h2><p><?php echo self::t( self::v( $s, 'text' ) ); ?></p><a class="btn" href="<?php echo self::u( self::v( $s, 'btn_link' ) ); ?>"><?php echo self::t( self::v( $s, 'btn_text' ) ); ?> <span>←</span></a><div class="cta-notes"><?php echo $notes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div></div></section>
		<?php
	}
}
